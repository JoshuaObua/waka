...
@section('title', config('company.name') . ' - Sauna Management')
...
<div class="block-header">
    <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
            <h2>Sauna Management</h2>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="/"><i class="zmdi zmdi-home"></i> {{ config('company.name') }}</a></li>
                <li class="breadcrumb-item active">Sauna Management</li>
            </ul>
            <button class="btn btn-primary btn-icon mobile_menu" type="button"><i class="zmdi zmdi-sort-amount-desc"></i></button>
        </div>
        <div class="col-lg-5 col-md-6 col-sm-12">                
            <button class="btn btn-primary btn-icon float-right right_icon_toggle_btn" type="button"><i class="zmdi zmdi-arrow-right"></i></button>
            <a href="/sauna/create" class="btn btn-info float-right mr-2"><i class="zmdi zmdi-plus"></i> Create Sauna Record</a>
        </div>
    </div>
</div>
            ...
            <div class="card">
                <div class="body">
                    <ul class="nav nav-tabs p-0 mb-3">
                        ...
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#plans-tab">Sauna Plans</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="tab-pane active" id="subscriptions-tab">
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Sauna</strong> Memberships</h2>
                        </div>
                        <div class="body">
                                    ...
                                    <tbody>
                                        @foreach($subscriptions as $sub)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="/sauna/subscriptions/{{ $sub['id'] }}/status" method="POST" class="d-inline status-form">
                                                        @csrf
        ...
        <div class="tab-pane" id="plans-tab">
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Available</strong> Sauna Packages</h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        @foreach($plans as $plan)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="/sauna/plans/{{ $plan['id'] }}/delete" method="POST" class="d-inline delete-form">
                                                        @csrf
