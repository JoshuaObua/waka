...
@section('title', config('company.name') . ' - Tenants List')
...
<div class="block-header">
    <div class="row">
        ...
        <div class="col-lg-5 col-md-6 col-sm-12">                
            ...
            <a href="/users/create" class="btn btn-info float-right mr-2"><i class="zmdi zmdi-plus"></i> Onboard New Tenant</a>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12">
            <div class="card">
                <div class="header">
                    <h2><strong>Registered</strong> Tenants</h2>
                </div>
                <div class="body">
        ...
        <form id="reset-pwd-form" method="POST" action="">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="resetPasswordModalLabel">Reset Tenant Password</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p>Reset password for tenant: <strong id="modal-user-name">User</strong></p>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-danger waves-effect">Reset Password</button>
                </div>
            </div>
        </form>
    </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            // Initialize JQuery DataTables with Export options
            ...
            // Map target data elements dynamically to the reset password modal
