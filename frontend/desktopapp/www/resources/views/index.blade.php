...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="active"><a href="/"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
            
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-city"></i><span>Properties & Units</span></a>
                <ul class="ml-menu">
                    <li><a href="/properties">Properties List</a></li>
                    <li><a href="/units">Rentable Units</a></li>
                </ul>
            </li>
            
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-accounts"></i><span>Tenants & Leases</span></a>
                <ul class="ml-menu">
                    <li><a href="/tenants">Tenants List</a></li>
                    <li><a href="/leases">Lease Contracts</a></li>
                </ul>
            </li>
            
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-receipt"></i><span>Billing & Invoices</span></a>
                <ul class="ml-menu">
                    <li><a href="/invoices">Invoices</a></li>
                </ul>
            </li>
            
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-balance-wallet"></i><span>Financials & Wallets</span></a>
                <ul class="ml-menu">
                    <li><a href="/wallets">Wallets & Ledgers</a></li>
                    <li><a href="/transactions">Gateway Transactions</a></li>
                </ul>
            </li>
            
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-settings"></i><span>User Management</span></a>
                <ul class="ml-menu">
