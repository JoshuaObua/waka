...
@section('title', config('company.name') . ' - Create Gym Record')
...
<div class="block-header">
    <div class="row">
        ...
        <div class="col-lg-5 col-md-6 col-sm-12">                
            ...
            <a href="/gym" class="btn btn-default btn-icon btn-round float-right m-r-10">
                <i class="zmdi zmdi-arrow-left"></i> <span>Back to Gym</span>
            </a>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-8 col-md-12 offset-lg-2">
            <div class="card">
                <div class="header">
                    <h2><strong>Add</strong> Gym Entry</h2>
                    <ul class="nav nav-tabs p-0 mb-3">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#subscribe-client-tab">Subscribe Client</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#add-plan-tab">Add Gym Plan</a></li>
                    </ul>
                </div>
                <div class="body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="subscribe-client-tab">
                            <form action="/gym/subscriptions" method="POST" id="subscriptionForm">
                                @csrf
                                <div class="form-group">
                                    <label for="client_name">Client Full Name <span class="text-danger">*</span></label>
                                    <input type="text" id="client_name" name="client_name" class="form-control" placeholder="e.g. Alice Kemigisha" required>
                                </div>

                                <div class="form-group">
                                    <label for="plan_id">Select Gym Plan <span class="text-danger">*</span></label>
                                ...
                                <div class="text-right">
                                    <a href="/gym" class="btn btn-default waves-effect m-r-10">Cancel</a>
                        ...
                        <div class="tab-pane" id="add-plan-tab">
                            <form action="/gym/plans" method="POST" id="planForm">
                                @csrf
                                <div class="form-group">
                                    <label for="name">Plan Name <span class="text-danger">*</span></label>
                                    <input type="text" id="name" name="name" class="form-control" placeholder="e.g. Monthly Standard" required>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="duration_days" name="duration_days" class="form-control" placeholder="e.g. 30" required>
                                        </div>
                                    </div>
                                </div>
